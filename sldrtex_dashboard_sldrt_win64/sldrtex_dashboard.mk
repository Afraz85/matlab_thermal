...
MODEL                := sldrtex_dashboard
MODULES              := rtGetInf.c rtGetNaN.c rt_nonfinite.c sldrtex_dashboard_data.c sldrtex_dashboard_tgtconn.c
MAKEFILE             := sldrtex_dashboard.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := sldrtex_dashboard_ref.rsp
...
# additional includes
REQ_INCLUDES += ;D:/Git/mat_thermal;D:/Git/mat_thermal/sldrtex_dashboard_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src

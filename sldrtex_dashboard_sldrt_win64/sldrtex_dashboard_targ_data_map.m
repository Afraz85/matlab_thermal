  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% sldrtex_dashboard_DW.TAQSigLogging_InsertedFor_Integrator1_at_outport_0_PWORK.AQHandles
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	
	  ;% sldrtex_dashboard_DW.TAQSigLogging_InsertedFor_Integrator1_at_outport_1_PWORK.AQHandles
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
  ...
  targMap.checksum0 = 4087268071;
  targMap.checksum1 = 961969258;
  targMap.checksum2 = 3363807875;
  targMap.checksum3 = 1713307411;

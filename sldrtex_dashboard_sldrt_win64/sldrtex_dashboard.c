...
void sldrtex_dashboard_output(void)
{
  ...
  if (sldrtex_dashboard_X.Integrator1_CSTATE >=
    ...
    if (sldrtex_dashboard_X.Integrator1_CSTATE >
      ...
      rtsiSetBlockStateForSolverChangedAtMajorStep
        (&sldrtex_dashboard_M->solverInfo, true);
    }
  ...
  if (rtmIsMajorTimeStep(sldrtex_dashboard_M)) {
    /* ToAsyncQueueBlock generated from: '<S1>/A: Output valve' */
    if (rtmIsMajorTimeStep(sldrtex_dashboard_M)) {
      {
        double time = sldrtex_dashboard_M->Timing.t[1];
        void *pData = (void *)&sldrtex_dashboard_B.Q2Outputflow;
        int32_T size = 1*sizeof(real_T);
        sendToAsyncQueueTgtAppSvc(3431103413U, time, pData, size);
      }
    }

    /* ToAsyncQueueBlock generated from: '<S1>/Integrator1' */
    if (rtmIsMajorTimeStep(sldrtex_dashboard_M)) {
      {
        double time = sldrtex_dashboard_M->Timing.t[1];
        void *pData = (void *)&sldrtex_dashboard_B.hWaterlevel;
        int32_T size = 1*sizeof(real_T);
        sendToAsyncQueueTgtAppSvc(1989144187U, time, pData, size);
      }
    }
    ...
    if (rtmIsMajorTimeStep(sldrtex_dashboard_M)) {
      {
        ...
        int32_T size = 1*sizeof(real_T);
        sendToAsyncQueueTgtAppSvc(1982251200U, time, pData, size);
      }
    }
  }
...
RT_MODEL_sldrtex_dashboard_T *sldrtex_dashboard(void)
{
  ...
  sldrtex_dashboard_P.RealTimeSynchronization_MaxMissedTicks = rtInf;
  ...
  /* External mode info */
  sldrtex_dashboard_M->Sizes.checksums[0] = (4087268071U);
  sldrtex_dashboard_M->Sizes.checksums[1] = (961969258U);
  sldrtex_dashboard_M->Sizes.checksums[2] = (3363807875U);
  sldrtex_dashboard_M->Sizes.checksums[3] = (1713307411U);
  ...
  sldrtex_dashboard_M->Sizes.numPeriodicContStates = (0);
